...
$stmt = $pdo->prepare("INSERT INTO vaccination an_tabl(id, name, times, vaccine_kinds, indate, comments)
VALUES(NULL, :id, name, times, vaccine kinds, indate, comments)");
$stmt->bindValue(':name', $name, PDO::PARAM_STR);  
$stmt->bindValue(':times', $times, PDO::PARAM_STR);  
$stmt->bindValue(':vaccine_kinds', $fvaccine_kinds, PDO::PARAM_STR);  
